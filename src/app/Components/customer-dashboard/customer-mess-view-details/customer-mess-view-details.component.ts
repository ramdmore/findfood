...
@Component({
  selector: 'app-customer-mess-view-details',
  standalone: false,
  templateUrl: './customer-mess-view-details.component.html',
  styleUrl: './customer-mess-view-details.component.css'
})
export class CustomerMessViewDetailsComponent implements OnInit {
